...
const Modal = ({ activeID, setShowModal }) => {
  ...
  return (
    <div className="w-full h-full fixed top-0 left-0 z-10 bg-headingColor bg-opacity-40">
      <div
        className="max-w-[600px] absolute top-1/2 z-20 bg-white rounded-[80] transform 
      ...
      >
        ...
        <div>
          ...
          <a href={portfolio.siteUrl}>
            <button
              className="bg-primaryColor text-white py-w px-4 my-8 rounded-[8px] font-[500]
        ...
        <button
          ...
          className="w-[1.8rem] h-[1.8rem] bg-[white] absolute 
        top-[1.7rem] right-[1.7rem] text-[25px] flex items-center justify-center rounded-[3px] leading-0"
        >
          &times;
        </button>
      </div>
